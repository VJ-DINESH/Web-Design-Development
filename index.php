...
<body>
  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg px-4 bg-light shadow-sm">
    <a class="navbar-brand" href="#">My Blog</a>
    <div class="ms-auto">
      <button id="darkModeToggle" class="btn btn-outline-dark" onclick="toggleDarkMode()">Dark Mode</button>
    </div>
  </nav>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <div class="card h-100">
          <img src="public/php.png" class="card-img-top p-2" alt="PHP Blog Image" />
          <div class="card-body">
            <h5 class="card-title">PHP Hypertext Preprocessor</h5>
            <p class="card-text">Server-side scripting language for web development.
            </p>
      ...
      <div class="col-md-4">
        <div class="card h-100">
          <img src="public/js.png" class="card-img-top p-2" alt="JS Blog Image" />
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card h-100">
          <img src="public/laravel.png" class="card-img-top p-2" alt="Laravel Blog Image" />
          <div class="card-body">
            <h5 class="card-title">Laravel Framework</h5>
            <p class="card-text">Elegant PHP framework for modern web apps.
                            </p>
            <a href="#" class="btn btn-primary">Read More</a>
          </div>
        </div>
